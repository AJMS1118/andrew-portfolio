  ...
  return (
    ...
    >
      <div className="flex items-center">
        <div className="flex items-center justify-center w-7 h-7 rounded-full bg-gray-100 dark:bg-gray-700 mr-[-0.5rem] z-10 border border-gray-200 dark:border-gray-600 overflow-hidden">
          {renderFlag(selectedLanguage.flagCode)}
        </div>

        <button
          className="flex items-center gap-1 rounded-r-md border-gray-200  pl-2.5 pr-1 py-1 bg-gray-300 dark:bg-[#1e1e1e] dark:text-gray-200"
